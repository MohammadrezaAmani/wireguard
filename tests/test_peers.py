import pytest
from subnet import IPv4Address, IPv6Address, ip_address

from wireguard import INTERFACE, PORT, Config, Peer
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            None,
            "fde2:3a65:ca93:3125:1234:abcd:4321:32",
        ),
        (
            "192.168.0.2",
            "fde2:3a65:ca93:3125:1234:abcd:4321:32",
...
def test_basic_peer(ipv4_address, ipv6_address):
    ...
    if ipv4_address and ipv6_address:
        assert (
            f"Address = {ipv4_address}/32,{ipv6_address}/128" in config_lines
            or f"Address = {ipv6_address}/128,{ipv4_address}/32" in config_lines
        )
    elif ipv6_address:
...
@pytest.mark.parametrize(
    ...
    [
        (
            "1280",
            "must be an integer",
        ),  # Technically valid, but being sent as str
        (
            False,
            "must be an integer",
        ),
